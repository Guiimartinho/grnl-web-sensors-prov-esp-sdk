...
//add
#define CONFIG_GSM_APN  "generica.claro.com.br"
#define CONFIG_GSM_TX 13
#define CONFIG_GSM_RX 2
...
const char *PPP_User = "claro";//CONFIG_GSM_INTERNET_USER;
const char *PPP_Pass = "claro";//CONFIG_GSM_INTERNET_PASSWORD;
...
static void ppp_status_cb(ppp_pcb *pcb, int err_code, void *ctx)
{
	...
	switch(err_code) {
		case PPPERR_NONE: {
            ...
            xEventGroupSetBits(status_event_group, GSM_CONNECTED_BIT);
